                ...
                <div>
                    ...
                    <div class="container">
                        ...
                        <div id="opcao1">
                            ...
                            'field','id'=>'example1','onclick'=>"alteraResposta('opcao1')"]) !!}
                        ...
                        <div id="opcao2">
                            ...
                            'id'=>'example2','onclick'=>"alteraResposta('opcao2')"]) !!}
                        ...
                        <div id="opcao3">
                            {!! Form::radio('example', 1, false, ['class' => 'field',
                            'id'=>'example3','onclick'=>"alteraResposta('opcao3')"]) !!}
                        ...
                        <div id="opcao4">
                            {!! Form::radio('example', 1, false, ['class' => 'field',
                            'id'=>'example4','onclick'=>"alteraResposta('opcao4')"]) !!}
                        ...
                        <div id="opcao5">
                            {!! Form::radio('example', 1, false, ['class' => 'field',
                            'id'=>'example5','onclick'=>"alteraResposta('opcao5')"]) !!}
