...
<header class="hero">
            ...
            <div class="row nav-wrapper">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                    <ul class="nav navbar-nav navbar-right hidden-xs">
                        <li>
                            <button class="btn btn-default" data-toggle="modal" data-target="#loginModal">Entrar
                            </button>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-xs-12" id="login-mobile">
                ...
                <div>
                    <form method="post" url="login">
                        ...
                        <input type="text" name="login-email" id="username-mobile" class="form-control"
                               placeholder='e-mail ou nome de utilizaor' required="true"/>
                        <input type="password" name="login-password" id="password-mobile" class="form-control"
                               placeholder="password" required="true"/>


                        @if(isset($errorMobile))
                            <label><strong>E-mail ou nome de utilizador e password não confere. Tente de
                                    novo</strong></label>
                        @endif
            ...
            <div class="col-xs-12 hidden-xs" id="registo-mobile">
                ...
                <div>
                    <form method="post" url="/">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type='hidden' name='mobile' id='opLogin' value='1'/>
                        <input type="text" id="nome-mobile" name="nome" class="form-control" placeholder="nome"
                               required="true"/>

                        <input type="text" id="apelido-mobile" name="apelido" class="form-control" placeholder="apelido"
                               required="true"/>

                        <input type="text" id="username-mobile" name="username" class="form-control"
                               placeholder="nome de utilizador" required="true"/>
                        ...
                        <div>
                            <div class="col-lg-6 col-md6 col-sm">
                                <label for="termos"><input type="checkbox" name="termos" id="termos" required="true"/>Aceitos
    ...
    <div class="down-arrow floating-arrow"><a class="scrolarAprender" href="#podeAprender"><i
        ...
        <div class="row dizendo">
            ...
            <div class="pessoa col-lg-4 col-md-4 col-sm-4 nam delay-05s animated fadeInUp" data-wow-delay="0.5s">
                ...
                <p class="text-center">&ldquo;Est&atilde;o de Parab&eacute;ns gostei
                    [da vossa plataforma, a simplicidade aplicada &eacute; incr&iacute;vel]...ir&iacute;a ajudar muitos
                    Estudantes...&rdquo;
                </p>
