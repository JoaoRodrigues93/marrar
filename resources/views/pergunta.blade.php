    ...
    <div class="container">
        ...
        <div class="jumbotron">
            <div class="form-group">
                ...
                {!! Form::select('disciplinas', $disciplinas , Input::old('disciplinas'), ['class' => 'form-control','id'=>'disciplinas'])
                !!}
                {!! Form::label('capitulo','Selecione o capitulo',['class'=>'text-primary']) !!}
                {!! Form::select('capitulos', $capitulos , Input::old('capitulos'),['class' => 'form-control','id'=>'capitulos'] ) !!}
