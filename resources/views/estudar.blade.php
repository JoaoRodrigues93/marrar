...
//            $("#conteud").load("/teoria.html");
            ...
            function submeter2(event) {
                var code = event.keyCode ? event.keyCode : event.which;
                var button2;
                if (code == 13) {
                    button2 = document.getElementById("show");
                    button2.click();

                }
            }
            function submeter3(event) {
                var code = event.keyCode ? event.keyCode : event.which;
                var button3;
                if (code == 13) {
                    button3 = document.getElementById("cont1");
                    button3.click();

                }
            }

            function submeter4(event) {
                var code = event.keyCode ? event.keyCode : event.which;
                var button4;
                if (code == 13) {
                    button4 = document.getElementById("cont2");
                    button4.click();
                }
            }
        </script>
